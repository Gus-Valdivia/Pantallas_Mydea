...
function copiarDatos(clickeado) {
    ...
    switch (id_busq) {
        case "negbusq":
            ...
            document.getElementById("id_neg_vp_neg").value = clickeado.querySelector("#id_neg_bus").value;
        ...
        case "usubusq":
            ...
            document.getElementById("id_usu_vp_elim").value = clickeado.querySelector("#idu").value;
            document.getElementById("neg_img_vp").style.display = "flex";
        ...
        case "vendbusq":
            ...
            document.getElementById("id_usuv_vp_elim").value = clickeado.querySelector("#idu").value;
        ...
        case "probusq":
            ...
            document.getElementById("id_pro_vp_elim").value = clickeado.querySelector("#idn_pro").value;
        ...
        case "combusq":
            ...
            document.getElementById("id_com_vp_elim").value = clickeado.querySelector("#idn_com").value;
            break;
        case "novbusq":
            document.getElementById("neg_img_vp").style.display = "flex";
            document.getElementById("secc_usuv_vp").style.display = "none";
            ...
            document.getElementById("id_nov_vp_elim").value = clickeado.querySelector("#idn_nov").value;
            break;
    }
}
